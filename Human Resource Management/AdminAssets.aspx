<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminAssets.aspx.cs" Inherits="Human_Resource_Management.AdminAssets" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <!-- Edit Assets Modal -->
            <div id="return_assets" class="modal custom-modal fade" role="dialog">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Edit Assets</h5>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="input-block mb-3">
                                <label class="col-form-label">LapTop <span class="text-danger">*</span></label>
                                <asp:CheckBox ID="CheckBox7" runat="server" CssClass="form-control" />
                            </div>

                            <div class="input-block mb-3">
                                <label class="col-form-label">Mouse <span class="text-danger">*</span></label>
                                <asp:CheckBox ID="CheckBox8" runat="server" CssClass="form-control" />
                            </div>

                            <div class="input-block mb-3">
                                <label class="col-form-label">Pendrive <span class="text-danger">*</span></label>
                                <asp:CheckBox ID="CheckBox9" runat="server" CssClass="form-control" />
                            </div>

                            <div class="input-block mb-3">
                                <label class="col-form-label">Mobile <span class="text-danger">*</span></label>
                                <asp:CheckBox ID="CheckBox10" runat="server" CssClass="form-control" />
                            </div>

                            <div class="input-block mb-3">
                                <label class="col-form-label">Bag <span class="text-danger">*</span></label>
                                <asp:CheckBox ID="CheckBox11" runat="server" CssClass="form-control" />
                            </div>

                            <div class="input-block mb-3">
                                <label class="col-form-label">Sim <span class="text-danger">*</span></label>
                                <asp:CheckBox ID="CheckBox12" runat="server" CssClass="form-control" />
                            </div>
                            <div class="input-block mb-3">
                                <label class="col-form-label">Return Remarks <span class="text-danger">*</span></label>
                                <asp:TextBox ID="TextBox3" runat="server" CssClass="form-control"></asp:TextBox>
                            </div>
                            <div class="submit-section">
                                <asp:Button ID="btnreturn" runat="server" Text="Submit" CssClass="btn btn-primary submit-btn" OnClick="btnreturn_Click" />
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        function returnassets(EmpId, Name, LapTop, Mouse, Pendrive, Mobile, Bag, Sim) {
            $('#<%= TextBox1.ClientID %>').val(EmpId).prop('readonly', true);
            $('#<%= HiddenField2.ClientID %>').val(EmpId);
            $('#<%= TextBox2.ClientID %>').val(Name);
            $('#<%= CheckBox7.ClientID %>').prop('checked', LapTop && LapTop.toLowerCase() === 'true');
            $('#<%= CheckBox8.ClientID %>').prop('checked', Mouse && Mouse.toLowerCase() === 'true');
            $('#<%= CheckBox9.ClientID %>').prop('checked', Pendrive && Pendrive.toLowerCase() === 'true');
            $('#<%= CheckBox10.ClientID %>').prop('checked', Mobile && Mobile.toLowerCase() === 'true');
            $('#<%= CheckBox11.ClientID %>').prop('checked', Bag && Bag.toLowerCase() === 'true');
            $('#<%= CheckBox12.ClientID %>').prop('checked', Sim && Sim.toLowerCase() === 'true');
            console.log("Sim is : " + Sim);
        }
    </script>
</asp:Content>
