...
namespace Human_Resource_Management
{
    public partial class AdminAddEmployee : System.Web.UI.Page
    {
        ...
        protected void btnaddemployee_Click(object sender, EventArgs e)
        {
            ...
            (
               [EmpId], [Salutation],[EmployeeId], [FirstName], [LastName], [Image], [EmployeeCode], [DOB], [DOJ], [Gender], [Company],
            ...
            VALUES
            (
               @EmpId, @Salutation, @EmployeeId,@FirstName, @LastName, @Image, @EmployeeCode, @DOB, @DOJ, @Gender, @Company, @Branch, @Department,
                ...
                @NomineeAadhar, @ShiftType, @Shift2, @Shift3
                    ...
                    using (SqlCommand sqlCmd = new SqlCommand(insertQuery, sqlConn))
                    {
                        ...
                        sqlCmd.Parameters.AddWithValue("@EmployeeId", TextBox2.Text);
                        ...
                        string branchCode = branchId.ToString();
                        ...
                        sqlCmd.Parameters.AddWithValue("@EmployeeCode", TextBox1.Text);
                        ...
                        if(ddladdshifttype.SelectedItem.Text == "Genaral")
                        {
                            sqlCmd.Parameters.AddWithValue("@Shift", txtaddshift1.Text);
                            sqlCmd.Parameters.AddWithValue("@Shift2", "0");
                            sqlCmd.Parameters.AddWithValue("@Shift3", "0");
                        }
                        else if(ddladdshifttype.SelectedItem.Text == "Rotational")
                        {
                            sqlCmd.Parameters.AddWithValue("@Shift", txtaddshift1.Text);
                        ...
                        if (i > 0)
                        {
                            Response.Write("<script>alert('"+ txtaddsurname.Text + " Added Successfully')</script>");
                            MaxEmpId();
                        }
                    }
                }
        ...
        public void ResetValues()
        {
            ...
            ddladdbranch.ClearSelection();
            ddladdbranch.ClearSelection();
            ddladddepartment.ClearSelection();
            TextBox4.Text = ""; 
            ddladdcompany.ClearSelection();
            ddladddepartment.ClearSelection();
            ...
            TextBox5.Text = "";
            TextBox6.Text = "";
            txtCompanyCellNo.Text = "";
            txtPersonalCelloNo.Text = "";
            ...
            txtBankAccNo.Text = "";
            txtIFSC.Text = "";
            ddlpfstatus.ClearSelection();
            txtPanNo.Text = "";
            txtaddshift3.Text = "";
            ddladdshifttype.ClearSelection();
            txtHighEducation1.Text = "";
            txtEducationYear1.Text = "";
            txtEducationUniversity1.Text = "";
            txtHighEducation2.Text = "";
            txtEducationYear2.Text = "";
            txtEducationUniversity2.Text = "";
            ddlmaritialstatus.ClearSelection();
            TextBox33.Text = "";
            TextBox34.Text = "";
            txtspousename.Text = "";
            txtRelation1.Text = "";
            ...
            txtMotherName.Text = "";
            txtMotherAdhar.Text = "";
             ddlempextype.ClearSelection();
            txtaddexpectedsalary.Text = "";
            txtexpirienceyears.Text = "";
            txtlast1company.Text = "";
            txtlast1salaryannum.Text = "";
            txtlast2companyname.Text = "";
            txtlast2companysalaryannum.Text = "";
            txtlast1designation.Text = "";
            txtlast2designation.Text = "";
            txtlast1fromyear.Text = "";
            txtlast1toyear.Text = "";
            txtlast2fromyear.Text = "";
            txtlast2toyear.Text = "";
            txtlast1mobile.Text = "";
            txtlast2companymobile.Text = "";
            txtFatherMobile.Text = "";
            txtMotherMobile.Text = "";
            txt1educationpercentage.Text = "";
            txt2educationpercentage.Text = "";
            txtnominename.Text = "";
            txtnominerelation.Text = "";
            txtnomineemobile.Text = "";
            txtnomineeadhar.Text = "";
            ddladdshifttype.SelectedItem.Text = "";
            txtaddshift2.Text = "";
            txtaddshift3.Text = "";
        }
        ...
        {
            int empId = Convert.ToInt32(TextBox1.Text.Trim());
            string formattedEmpId = "BT-" + empId;
            ...
            using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["NewHRMSString"].ConnectionString))
            {
                ...
                string checkEmpIdQuery = "SELECT COUNT(*) FROM Employees WHERE EmpId = @EmployeeId";
                SqlCommand checkEmpIdCmd = new SqlCommand(checkEmpIdQuery, con);
                checkEmpIdCmd.Parameters.AddWithValue("@EmployeeId", empId);

                int count = (int)checkEmpIdCmd.ExecuteScalar();

                if (count > 0)
                {
                    // Retrieve the FirstName based on the entered EmpId
                    string getFirstNameQuery = "SELECT FirstName FROM Employees WHERE EmpId = @EmployeeId";
                    SqlCommand getFirstNameCmd = new SqlCommand(getFirstNameQuery, con);
                    getFirstNameCmd.Parameters.AddWithValue("@EmployeeId", empId);

                    string firstName = (string)getFirstNameCmd.ExecuteScalar();

                    Label1.ForeColor = System.Drawing.Color.Red;
                    Label1.Text = $"{TextBox1.Text} Id already assigned to {firstName}.";
                    TextBox1.Text = "";
                }
                else
                {
                    Label1.ForeColor = System.Drawing.Color.Green;
                    Label1.Text = "Possible Id";
                    TextBox2.Text = formattedEmpId;
                }
            }
        }
        public void MaxEmpId()
        {
            using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["NewHRMSString"].ConnectionString))
            {
                try
                {
                    con.Open(); 
                    string query = "SELECT MAX(EmpID) FROM Employees";
                    SqlCommand cmd = new SqlCommand(query, con);

                    object result = cmd.ExecuteScalar();
                    int maxEmpId = result != DBNull.Value ? Convert.ToInt32(result) : 0;
                    int availbleid = maxEmpId + 1;
                    Label1.ForeColor = System.Drawing.Color.DeepPink;
                    Label1.Text = $"Availble Employee ID is {availbleid}";
                }
                catch (Exception ex)
                {
