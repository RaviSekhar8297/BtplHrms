<%@ Page Title="" Language="C#" MasterPageFile="~/Manager.Master" AutoEventWireup="true" CodeBehind="ManagerPayRoll.aspx.cs" Inherits="Human_Resource_Management.ManagerPayRoll" %>
                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <div class="input-block mb-3">
                            ...
                            <asp:DropDownList ID="ddlname" runat="server" CssClass="form-control" onfocus="ddladdnamedisable()"></asp:DropDownList>
                        </div>
                    </div>
                    <div class="col-md-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 card-container">
                        <div class="stats-info card-presents">
                            ...
                            <h6 style="color: grey;">Half Day Count</h6>
                            <h3>
