<%@ Page Title="" Language="C#" MasterPageFile="~/Manager.Master" AutoEventWireup="true" CodeBehind="ManagerChat.aspx.cs" Inherits="Human_Resource_Management.ManagerChat" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function selectEmployee(empId) {
            ...
            if (sessionEmpId) {
                window.location.href = "ManagerChat.aspx?empId=" + encodeURIComponent(empId) + "&SId=" + encodeURIComponent(sessionEmpId);
            } else {
