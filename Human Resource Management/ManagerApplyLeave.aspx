<%@ Page Title="" Language="C#" MasterPageFile="~/Manager.Master" AutoEventWireup="true" CodeBehind="ManagerApplyLeave.aspx.cs" Inherits="Human_Resource_Management.ManagerApplyLeave" %>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto float-end ms-auto">
                            <div class="view-icons">
                                <a href="ManagerLeaves.aspx" class="list-view btn btn-link "><i class="fa-solid fa-bars"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="submit-section">
                            <asp:Button ID="btnapplyleave" runat="server" Text="Apply Leave" CssClass="btn btn-primary submit-btn" OnClick="btnapplyleave_Click"  ValidationGroup="vgForm" />
                        </div>
                    </div>
                </div>
            </div>
