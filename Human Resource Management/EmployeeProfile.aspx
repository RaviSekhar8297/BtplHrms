<%@ Page Title="" Language="C#" MasterPageFile="~/Employee.Master" AutoEventWireup="true" CodeBehind="EmployeeProfile.aspx.cs" Inherits="Human_Resource_Management.EmployeeProfile" %>
                                        ...
                                        <div class="col-md-5">
                                            <div class="profile-info-left">
                                                <h3 class="user-name m-t-0 mb-0">
                                                    <asp:Label ID="lblempname" runat="server" ForeColor="#ff0000"></asp:Label></h3>
                                                <h5 class="text-muted">Designation :<asp:Label ID="lbldesignation" runat="server"></asp:Label></h5>
                                                <h5 class="text-muted">Department :
                                                    <asp:Label ID="lbldepartment" runat="server"></asp:Label></h5>
                                                <h5 class="text-muted">Employee Id :
                                                    <asp:Label ID="lblempid" runat="server"></asp:Label></h5>
                                                <h5 class="small doj text-muted">DOJ :
                                                    <asp:Label ID="lbldoj" runat="server"></asp:Label></h5>
                ...
                <div id="emp_profile" class="pro-overview tab-pane fade show active">
                    <div class="row">
                        <div class="col-md-6 d-flex">
                            <div class="card profile-box flex-fill">
                                <div class="card-body">
                                    <h3 class="card-title" style="color: #128230;">Personal Informationss <a href="#" class="edit-icon" data-bs-toggle="modal" data-bs-target="#personal_info_modal">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 d-flex">
                            <div class="card profile-box flex-fill">
                                <div class="card-body">
                                    <h3 class="card-title">Nominee Information <a href="#" class="edit-icon" data-bs-toggle="modal" data-bs-target="#family_info_modal"><i class='fa-solid fa-pencil m-r-5'></i></a></h3>
                    ...
                    <div class="row">
                        <div class="col-md-6 d-flex">
                            <div class="card profile-box flex-fill">
                                <div class="card-body">
                                    <h3 class="card-title">Education Informations <a href="#" class="edit-icon" data-bs-toggle="modal" data-bs-target="#education_info"><i class='fa-solid fa-pencil m-r-5'></i></a></h3>
                        ...
                        <div class="col-md-6 d-flex">
                            <div class="card profile-box flex-fill">
                                <div class="card-body">
                                    <h3 class="card-title">Experience <a href="#" class="edit-icon" data-bs-toggle="modal" data-bs-target="#experience_info"><i class='fa-solid fa-pencil m-r-5'></i></a></h3>
                                    <div class="experience-box">
                                        <ul class="experience-list">
                                            <li>
                                                <div class="experience-user">
                ...
                <div class="tab-pane fade" id="emp_assets">
                    <div class="table-responsive table-newdatatable">
                        <table class="table table-new custom-table mb-0 datatable">
                            ...
                            <tbody>
                                <asp:PlaceHolder ID="AssetThings" runat="server"></asp:PlaceHolder>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="input-block mb-3">
                                    <label class="col-form-label">Name</label>
                                    <asp:TextBox ID="txtpername" runat="server" CssClass="form-control" AutoCompleteType="Disabled" ReadOnly="true"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input-block mb-3">
                                    <label class="col-form-label">Sur Name</label>
                                    <asp:TextBox ID="txtsurname" runat="server" CssClass="form-control" AutoCompleteType="Disabled"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input-block mb-3">
                                    <label class="col-form-label">DOJ</label>
                                    <asp:TextBox ID="txtperDOJ" runat="server" CssClass="form-control" TextMode="Date" ReadOnly="true"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input-block mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="input-block mb-3">
                                    ...
                                    <asp:TextBox ID="txpertmobile" runat="server" CssClass="form-control" AutoCompleteType="Disabled"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input-block mb-3">
                                    <label class="col-form-label">BloodGroup <span class="text-danger">*</span></label>
                                    <asp:TextBox ID="txtperbloodgroup" runat="server" CssClass="form-control" AutoCompleteType="Disabled"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input-block mb-3">
                                    <label class="col-form-label">EmployeeType</label>
                                    <asp:TextBox ID="txtemployeetype" runat="server" CssClass="form-control" AutoCompleteType="Disabled"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input-block mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="input-block mb-3">
                                    ...
                                    <asp:TextBox ID="txtperemail" runat="server" CssClass="form-control" AutoCompleteType="Disabled"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="submit-section">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="input-block mb-3">
                                                ...
                                                <asp:TextBox ID="TextBox19" runat="server" CssClass="form-control" AutoCompleteType="Disabled"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="input-block mb-3">
                                                <label class="col-form-label">Relationship <span class="text-danger">*</span></label>
                                                <asp:TextBox ID="TextBox24" runat="server" CssClass="form-control" AutoCompleteType="Disabled"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="input-block mb-3">
                                                <label class="col-form-label">Aadhar <span class="text-danger">*</span></label>
                                                <asp:TextBox ID="TextBox25" runat="server" CssClass="form-control" AutoCompleteType="Disabled"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="input-block mb-3">
                                                <label class="col-form-label">Phone <span class="text-danger">*</span></label>
                                                <asp:TextBox ID="TextBox28" runat="server" CssClass="form-control" AutoCompleteType="Disabled"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <%--	<div class="add-more">
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="input-block mb-3">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtfathernamepri"
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-block mb-3">
                                            ...
                                            <asp:RegularExpressionValidator
                                                ID="revCompanyCellNo"
                                                runat="server"
                                                ControlToValidate="txtfatherphone"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="input-block mb-3">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtemcmothername"
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-block mb-3">
                                            ...
                                            <asp:RegularExpressionValidator
                                                ...
                                                runat="server"
                                                ControlToValidate="txtmotherphone"
                                                ValidationExpression="^\d{10}$"
                                                ErrorMessage="10-digit mobile number without spaces."
                                                CssClass="text-danger"
                                                ValidationGroup="vgForm" />
                        ...
                        <div class="submit-section">
                            <asp:Button ID="btnemccontactdetailsupdate" runat="server" Text="Update" CssClass="btn btn-primary submit-btn" ValidationGroup="vgForm" OnClick="btnemccontactdetailsupdate_Click" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-scroll">
                            <div class="card">
                                <div class="card-body">
                                    <h3 class="card-title">Last One Education Informations <a href="javascript:void(0);" class="delete-icon"><i class="fa-regular fa-trash-can"></i></a></h3>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="input-block mb-3 form-focus focused">
                                                <asp:TextBox ID="TextBox14" runat="server" class="form-control floating" AutoCompleteType="Disabled"></asp:TextBox>
                                                <label class="focus-label">University</label>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="input-block mb-3 form-focus focused">
                                                <asp:TextBox ID="TextBox15" runat="server" class="form-control floating" AutoCompleteType="Disabled"></asp:TextBox>
                                                <label class="focus-label">Degree</label>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="input-block mb-3 form-focus focused">
                                                <asp:TextBox ID="TextBox16" runat="server" class="form-control floating" AutoCompleteType="Disabled"></asp:TextBox>
                                                <label class="focus-label">Complete Date</label>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="input-block mb-3 form-focus focused">
                                                <asp:TextBox ID="TextBox17" runat="server" class="form-control floating" AutoCompleteType="Disabled"></asp:TextBox>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="input-block mb-3 form-focus focused">
                                                <asp:TextBox ID="TextBox20" runat="server" class="form-control floating" AutoCompleteType="Disabled"></asp:TextBox>
                                                <label class="focus-label">University</label>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="input-block mb-3 form-focus focused">
                                                <asp:TextBox ID="TextBox21" runat="server" class="form-control floating" AutoCompleteType="Disabled"></asp:TextBox>
                                                <label class="focus-label">Degree</label>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="input-block mb-3 form-focus focused">
                                                <asp:TextBox ID="TextBox22" runat="server" class="form-control floating" AutoCompleteType="Disabled"></asp:TextBox>
                                                <label class="focus-label">Complete Date</label>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="input-block mb-3 form-focus focused">
                                                <asp:TextBox ID="TextBox23" runat="server" class="form-control floating" AutoCompleteType="Disabled"></asp:TextBox>
                                                <label class="focus-label">Percentage</label>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="input-block mb-3 form-focus focused">
                                                <asp:TextBox ID="TextBox26" runat="server" class="form-control floating" AutoCompleteType="Disabled"></asp:TextBox>
                                                <label class="focus-label">Company Name</label>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="input-block mb-3 form-focus focused">
                                                <asp:TextBox ID="TextBox27" runat="server" class="form-control floating" AutoCompleteType="Disabled"></asp:TextBox>
                                                <label class="focus-label">SalaryAnnum</label>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="input-block mb-3 form-focus focused">
                                                <asp:TextBox ID="txtlastonedesignation" runat="server" class="form-control floating" AutoCompleteType="Disabled"></asp:TextBox>
                                                <label class="focus-label">Last1CompanyDesignation</label>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="input-block mb-3 form-focus focused">
                                                <asp:TextBox ID="TextBox1" runat="server" class="form-control floating" AutoCompleteType="Disabled"></asp:TextBox>
                                                <label class="focus-label">From1Year</label>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="input-block mb-3 form-focus focused">
                                                <asp:TextBox ID="TextBox2" runat="server" class="form-control floating" AutoCompleteType="Disabled"></asp:TextBox>
                                                <label class="focus-label">To1Year</label>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="input-block mb-3 form-focus focused">
                                                <asp:TextBox ID="TextBox3" runat="server" class="form-control floating" AutoCompleteType="Disabled"></asp:TextBox>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="input-block mb-3 form-focus focused">
                                                <asp:TextBox ID="TextBox31" runat="server" class="form-control floating" AutoCompleteType="Disabled"></asp:TextBox>
                                                <label class="focus-label">Company Name</label>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="input-block mb-3 form-focus focused">
                                                <asp:TextBox ID="TextBox32" runat="server" class="form-control floating" AutoCompleteType="Disabled"></asp:TextBox>
                                                <label class="focus-label">SalaryAnnum</label>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="input-block mb-3 form-focus focused">
                                                <asp:TextBox ID="txtlasttwodesignation" runat="server" class="form-control floating" AutoCompleteType="Disabled"></asp:TextBox>
                                                <label class="focus-label">Last2CompanyDesignation</label>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="input-block mb-3 form-focus focused">
                                                <asp:TextBox ID="TextBox4" runat="server" class="form-control floating" AutoCompleteType="Disabled"></asp:TextBox>
                                                <label class="focus-label">From2Year</label>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="input-block mb-3 form-focus focused">
                                                <asp:TextBox ID="TextBox13" runat="server" class="form-control floating" AutoCompleteType="Disabled"></asp:TextBox>
                                                <label class="focus-label">To2Year</label>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="input-block mb-3 form-focus focused">
                                                <asp:TextBox ID="TextBox18" runat="server" class="form-control floating" AutoCompleteType="Disabled"></asp:TextBox>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="input-block mb-3">
                                        ...
                                        <asp:TextBox ID="txtbankname" runat="server" CssClass="form-control" AutoCompleteType="Disabled"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="input-block mb-3">
                                        <label class="col-form-label">Bank Account Number <span class="text-danger">*</span></label>
                                        <asp:TextBox ID="txtbankaccountnumber" runat="server" CssClass="form-control" AutoCompleteType="Disabled"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="input-block mb-3">
                                        ...
                                        <asp:RegularExpressionValidator
                                            ...
                                            runat="server"
                                            ControlToValidate="txtifsc"
                                            ErrorMessage="Invalid IFSC code. Format must be 4 uppercase letters followed by 7 digits."
                                ...
                                <div class="col-md-6">
                                    <div class="input-block mb-3">
                                        ...
                                        <asp:RegularExpressionValidator
                                            ...
                                            CssClass="text-danger"
                                            ValidationGroup="vgForm"></asp:RegularExpressionValidator>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="submit-section">
                        <asp:Button ID="btnbankupdatepopup" runat="server" Text="Update" CssClass="btn btn-primary submit-btn" ValidationGroup="vgForm" OnClick="btnbankupdatepopup_Click" />
                    </div>
                </div>
            </div>
        </div>
