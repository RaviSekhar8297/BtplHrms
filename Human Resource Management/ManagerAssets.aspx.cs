...
{
    public partial class ManagerAssets : System.Web.UI.Page
    {
        ...
        public void BindAssets()
        {
            try
            {
                ...
                {
                    using (SqlCommand sqlcmd = new SqlCommand("SELECT * FROM Assets where Status='1' and Department=@DepartmentName", connection))
                    {
                        sqlcmd.Parameters.AddWithValue("@DepartmentName", Deptname);
                        connection.Open();
