<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminAddResignation.aspx.cs" Inherits="Human_Resource_Management.AdminAddResignation" %>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="input-block mb-3">
                            ...
                            <asp:DropDownList ID="ddlcompanyresign" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlcompanyresign_SelectedIndexChanged" onfocus="disablecompany()">
                            </asp:DropDownList>
                    ...
                    <div class="col-md-4">
                        <div class="input-block mb-3">
                            ...
                            <asp:DropDownList ID="ddlbranchresign" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlbranchresign_SelectedIndexChanged" onfocus="disablebranch()">
                            </asp:DropDownList>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="input-block mb-3">
                            ...
                            <asp:DropDownList ID="ddldepartmentresign" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddldepartmentresign_SelectedIndexChanged" onfocus="disabledepartment()">
                            </asp:DropDownList>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="input-block mb-3">
                            ...
                            <asp:DropDownList ID="ddlnameresign" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlnameresign_SelectedIndexChanged" onfocus="disablename()">
                            </asp:DropDownList>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="input-block mb-3">
                            ...
                            <asp:DropDownList ID="ddldesignationresign" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddldesignationresign_SelectedIndexChanged">
                            </asp:DropDownList>
                        </div>  
                    </div>
                    <div class="col-md-4">   
                        <div class="input-block mb-3">
                            ...
                            <asp:TextBox ID="txtaddnoticedate" runat="server" CssClass="form-control" TextMode="Date" AutoCompleteType="Disabled" ReadOnly="true"></asp:TextBox>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="input-block mb-3">
